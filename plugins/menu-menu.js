...
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡║
║➤ *ВЛАДЕЛЕЦ:* РУСЛАН
║➤ *НОМЕР:* wa.me/77789008940
║➤ *Fecha:* ${ДАТА}
║➤ *Активное время:* ${ВРЕМЯ}
...
┏━━━━━━━━━━━━━━━━┓
┃ *< АКТИВИРОВАТЬ ИЛИ ДИАКТИВИРОВАТЬ />*
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
┣ ඬ⃟ ☑️ _${usedPrefix}включить *приветствие*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *приветствие*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *modohorny*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *modohorny*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *антиссылка*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *антиссылка*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *антиссылка2*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *антиссылка2*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *detect*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *detect*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить*аудио*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *аудио*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *автостикер*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *автостикер*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *antiviewonce*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *antiviewonce*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *антитоксичный*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить*антитоксичный*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *антитраба*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *антитраба*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *антиараб*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *антиараб*_
┣ ඬ⃟ ☑️ _${usedPrefix}включить *толькоадмин*_
┣ ඬ⃟ ☑️ _${usedPrefix}отключить *толькоадмин*_
┗━━━━━━━━━━━━━━━━┛
...
┣ ඬ⃟ 💎 _${usedPrefix}груповоевремя *<опция> <время>*_
...
┃ *< 𝔸𝕌𝔻𝕀𝕆𝕊 />*   
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
┃ *- 𝙴𝚂𝙲𝚁𝙸𝙱𝙴 𝙻𝙰𝚂 ДАЛЕЕ𝚂 𝙿𝙰𝙻𝙰𝙱𝚁𝙰𝚂 𝙾 𝙵𝚁𝙰𝚂𝙴𝚂 𝚂𝙸𝙽 𝙽𝙸𝙽𝙶𝚄𝙽 𝙿𝚁𝙴𝙵𝙸𝙹𝙾 (#, /, *, .)* 
┃ _- (𝑢𝑠𝑜 𝑠𝑖𝑛 𝑝𝑟𝑒𝑓𝑖𝑗𝑜)_
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
...
conn.reply(m.chat, '*[❗ИНФО❗] В МЕНЮ ОШИБКА, СООБЩИТЕ ВЛАДЕЛЬЦУ БОТА*', m)
}}
